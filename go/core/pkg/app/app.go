...
func (cfg *Config) SetFlags(commandLine *flag.FlagSet) {
	...
	commandLine.StringVar(&agent_translator.DefaultAuraImage, "aura-image", agent_translator.DefaultAuraImage, "The container image used for declarative agents with runtime 'aura' (Mezmo AURA).")
